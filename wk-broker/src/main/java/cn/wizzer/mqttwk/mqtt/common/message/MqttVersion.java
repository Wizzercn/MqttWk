...
import cn.wizzer.mqttwk.mqtt.common.exception.MqttUnacceptableProtocolVersionException;
import cn.wizzer.mqttwk.mqtt.common.utils.ObjectUtil;
...
public enum MqttVersion {
    ...
    public byte[] protocolNameBytes() {
        return name.getBytes(Encoding.CHARSET_UTF8);
    }
